...
//  Breakpoint
//
//  Created by Ondřej Svojše on 06.01.18.
//  Copyright © 2018 Ondřej Svojše. All rights reserved.
//
...
class QuestionsVC: UIViewController {
    ...
    @IBOutlet weak var rngSlider: UISlider!
    ...
    @IBAction func multipleAnswerBtnPressed(_ sender: UIButton) {
    ...
    @IBAction func rangedAnswerBtnPressed(_ sender: Any) {
        ...
        let currentAnswers = questions[questionIndex].answers
        let index = Int(round(rngSlider.value * Float(currentAnswers.count - 1)))
    ...
    func updateRangedStack(using answers: [Answer]) {
        ...
        rngSlider.setValue(0.5, animated: false)
